...
Tại sao?
Rule cuối:
#demo.text.highlight { color: black; }
Có specificity cao nhất: (1,2,0)

Nếu đổi thứ tự CSS thì sao?
Kết quả: KHÔNG đổi
Vì:
CSS ưu tiên specificity trước
Thứ tự chỉ có tác dụng khi specificity bằng nhau